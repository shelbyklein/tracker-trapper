...
<section class="preview-section wrap"><aside class="preview-notice" aria-labelledby="preview-heading"><span class="preview-bird" aria-hidden="true"><img class="preview-bird-check" src="<?php echo tt_asset('bird-green.webp'); ?>" alt="" width="1024" height="1024" loading="lazy"><img class="preview-bird-x" src="<?php echo tt_asset('bird-red-distraught.webp'); ?>" alt="" width="1280" height="1280" loading="lazy"></span><div class="preview-copy"><span class="eyebrow">A little bird, a little caution</span><h3 id="preview-heading">Early preview. Expect rough edges.</h3><p>This experimental software has limited testing and has not been broadly tested on other Macs. Bugs, missed updates, or unexpected behavior are possible. Keep backups and verify important work yourself.</p><p><strong>Signed, but not notarized.</strong> This build is Developer ID-signed, but has not been notarized by Apple. macOS may block it or show a security warning. Only proceed if you trust the source; if you’re unsure, wait for a notarized release.</p><p>Task progress stays on your Mac. GitHub features and your coding agents use their own services and accounts. Connecting an agent requires setup; Tracker Trapper does not automatically follow every conversation.</p><div class="preview-links"><a href="https://github.com/shelbyklein/tracker-trapper">View the project on GitHub ↗</a><a href="https://github.com/shelbyklein/tracker-trapper/issues">Report a bug ↗</a></div></div></aside></section>
